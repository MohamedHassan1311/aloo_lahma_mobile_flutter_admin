...
class PrivacyPolicy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: getTranslated("privacy_policy")),
      body: SafeArea(
        child: BlocProvider(
          create: (context) => PrivacyPolicyBloc(repo: sl<SettingsRepo>(),internetConnection: sl<InternetConnection>())..add(Click(),),
            ...
            builder: (context, state) {
              ...
              if (state is Error || state is Empty) {
                return RefreshIndicator(
                  ...
                  onRefresh: () async {
                    context.read<PrivacyPolicyBloc>().add(Click());
                  },
                  child: Column(
                    children: [
                      Expanded(
