...
class PrivacyPolicyBloc extends HydratedBloc<AppEvent, AppState> {
  final SettingsRepo repo;
  final InternetConnection internetConnection;

  PrivacyPolicyBloc({required this.repo, required this.internetConnection})
      : super(Start()) {
    on<Click>(onClick);
  }
  ...
  Future<void> onClick(Click event, Emitter<AppState> emit) async {
    try {
      emit(Loading());
      Either<ServerFailure, Response> response = await repo.getPrivacyPolicy();
