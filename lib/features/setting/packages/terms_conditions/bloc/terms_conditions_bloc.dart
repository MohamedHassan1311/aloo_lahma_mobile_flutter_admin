...
class TermsConditionsBloc extends HydratedBloc<AppEvent, AppState> {
  final SettingsRepo repo;
  final InternetConnection internetConnection;

  TermsConditionsBloc({required this.repo, required this.internetConnection})
      : super(Start()) {
    on<Click>(onClick);
  }
